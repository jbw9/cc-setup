...
<!-- Vendored from the official claude-plugins marketplace (frontend-design plugin),
     2026-09-09, with LICENSE.txt. Vendored rather than installed as a plugin so a
     fresh machine gets it from install.sh with no marketplace step. -->
